...
<tr>
<td><div class="tvox-puls"><a href="<?php echo(home_url()); ?>"><img id="bot-home" src="<?php echo($tvox_images_url);?>bottone_<?php if (is_front_page()) echo ('att'); ?>.gif" alt="Home" /></a><a href="<?php echo(home_url()); ?>"><img id="label-home" src="<?php echo($tvox_images_url);?>home_<?php if (is_front_page()) echo ('att'); ?>.gif" alt="Home" /></a></div></td>
